...
import il.co.matrix_yissachar.views.fragments.adapters.AllBenefitsAdapter;

public class AllBenefitsFragment extends Fragment {
    ...
    private void updateBenefitsUi(ArrayList<Benefit> benefits) {
        AllBenefitsAdapter adapter = new AllBenefitsAdapter(filterByCategory(benefits, 1), mainViewModel);
        categoryOne.setAdapter(adapter);
        adapter = new AllBenefitsAdapter(filterByCategory(benefits, 2), mainViewModel);
        categoryTwo.setAdapter(adapter);
        adapter = new AllBenefitsAdapter(filterByCategory(benefits, 3), mainViewModel);
        categoryThree.setAdapter(adapter);
        adapter = new AllBenefitsAdapter(filterByCategory(benefits, 4), mainViewModel);
        categoryFour.setAdapter(adapter);
        adapter = new AllBenefitsAdapter(filterByCategory(benefits, 5), mainViewModel);
